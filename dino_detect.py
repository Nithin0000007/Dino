...
#####
    # Find contours                                                                                                                                                                          
    #image, contours, hierarchy = cv2.findCont        ours(thresh, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    try:
        ...
        if count_defects >= 4:
                ...
                cv2.putText(frame, "boost", (115, 80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)

        #PLAY RACING GAMES (WASD)
        # """
        # if count_defects == 1:
        #     pyautogui.press('w')
        #     cv2.putText(frame, "striaght", (115, 80), cv2.FONT_HERSHEY_SIMPLEX, 2, 2, 2)
        if count_defects == 2:
